            ...
            $(".rev_slider").revolution({
              ...
              navigation: {
                ...
                bullets: {
                  ...
                  v_offset:30,
                  space:5,
                  tmp:'<span class="tp-bullet-img-wrap">  <span class="tp-bullet-image"></span></span><span class="tp-bullet-title">test</span>'
                }
              },
                ...
                <div class="form-group mb-15">
                  <div class="styled-select">
                    <select id="car_select" name="car_select" class="form-control" required="">
                      ...
                      <option value="Banking Honours">Banking Honours</option>
                      <option value="Games Technologies">Games Technologies</option>
              ...
              <div class="item">
                <div class="team-members maxwidth400">
                  ...
                  <div class="team-bottom-part border-bottom-theme-color-2-2px bg-lighter border-1px text-center p-10 pt-20 pb-10">
                    ...
                    <h5 class="text-theme-colored">Teacher - CSE</h5>
                    <ul class="styled-icons icon-sm icon-dark icon-theme-colored">
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                      <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                      <li><a href="#"><i class="fa fa-instagram"></i></a></li>
              ...
              <div class="item">
                <div class="team-members maxwidth400">
                  ...
                  <div class="team-bottom-part border-bottom-theme-color-2-2px bg-lighter border-1px text-center p-10 pt-20 pb-10">
                    ...
                    <h5 class="text-theme-colored">Teacher - BBA</h5>
                    <ul class="styled-icons icon-sm icon-dark icon-theme-colored">
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                      <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                      <li><a href="#"><i class="fa fa-instagram"></i></a></li>
              ...
              <div class="item">
                <div class="team-members maxwidth400">
                  ...
                  <div class="team-bottom-part border-bottom-theme-color-2-2px bg-lighter border-1px text-center p-10 pt-20 pb-10">
                    ...
                    <h5 class="text-theme-colored">Teacher - EEE</h5>
                    <ul class="styled-icons icon-sm icon-dark icon-theme-colored">
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                      <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                      <li><a href="#"><i class="fa fa-instagram"></i></a></li>
